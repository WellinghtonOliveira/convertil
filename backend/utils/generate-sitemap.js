...
const backendFrontendDir = path.join(__dirname, "../frontend")
...
function generateSitemap() {
  ...
  const frontendPages = getIndexPages(frontendDir)
  const backendFrontendPages = getIndexPages(backendFrontendDir)

  urls.push(...frontendPages, ...backendFrontendPages)
