const dados = [
    ...
    { category: 'design', name: 'Gerador de favicon', description: 'Crie um favicon para seu site - é rápido e fácil! envie sua própria imagem (SVG, JPG e PNG).', link: './gerador-de-favicon/' },
