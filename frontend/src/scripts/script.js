// Função para gerar as categorias aleatórias
// function getRandomCategory() {
//     const categories = ['design', 'dev', 'productivity', 'marketing', 'finance'];
//     return categories[Math.floor(Math.random() * categories.length)];
// }

// TODO lembrar de catalogar os nomes e endereço das ferramentas em um arquivo externo
                                    ...
                                    <a href="coloqueAqui${i}.html" class="block">
                                        <div class="p-5">
                                            <div class="flex items-center mb-4">
                                                ...
                                                <div class="ml-4">
                                                    <h3 class="text-lg font-medium text-gray-900">coloqueAqui${i}</h3>
                                            ...
                                            <p class="text-gray-600">Descrição breve da ferramenta coloqueAqui${i} e sua principal funcionalidade.</p>
                                        </div>
